...
//index.php
$connect = new PDO("mysql:host=localhost;dbname=db_cart", "root", "");
...
<html>
 <head>
    <title>Simple Shopping Cart Using Cookies</title>
 ...
 <body>
    ...
    <div class="container">
    <br />
    <h3 align="center">Simple Shopping Cart Using Cookies</h3><br />
    <br /><br />
    <?php
